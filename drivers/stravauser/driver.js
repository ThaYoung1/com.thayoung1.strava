...
class StravaUserDriver extends Homey.Driver  {
  ...
  async initOAuth2(session){
    const authUrl = `https://www.strava.com/oauth/authorize?client_id=${this.clientId}&response_type=code&redirect_uri=https://callback.athom.com/oauth2/callback/&scope=activity:read_all,profile:read_all,profile:write,activity:write`; 
